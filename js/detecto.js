function funcion_previa() {
	texto_final = " ";						//declaramos las variables para cada una de las 3 columnas de texto de la aplicación
	texto_final2 = " ";
	texto_final3 = " ";
	
	elementos_evitados = [];				//variable para recoger elementos que no se van a analizar
	indice_error=0;							//variable para crear un vector con los errores
	
	errores_importantes = [];				//variable para detectar todos los errores importantes
	evitar= 1;								//variable para evitar mensajes sin contenido
	...
	metar_viento="NOWIND";					//declaración de variables de viento, visibilidad, rvr, tiempo significativo, nubosidad y visibilidad vertical
